...
```bash
sudo apt update
sudo apt install -y live-build xorriso squashfs-tools debootstrap dctrl-tools librsvg2-bin syslinux-common syslinux-utils syslinux isolinux grub-pc-bin grub-efi-amd64-bin mtools dosfstools
```
