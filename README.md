...
```bash
sudo apt update
sudo apt install -y live-build xorriso squashfs-tools debootstrap syslinux-common syslinux-utils syslinux isolinux grub-pc-bin grub-efi-amd64-bin mtools dosfstools
```
